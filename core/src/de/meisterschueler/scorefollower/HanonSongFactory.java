...
public class HanonSongFactory {
	...
	private Song getNo(int no) {
		...
		case 0: {
			...
			leftScores = generateScores(Hand.LEFT, Arrays.asList(patternUp, patternDown), Arrays.asList(leftFingersUp, leftFingersDown), Arrays.asList(stepsUp, stepsDown));
			rightScores = generateScores(Hand.RIGHT, Arrays.asList(patternUp, patternDown), Arrays.asList(rightFingersUp, rightFingersDown), Arrays.asList(stepsUp, stepsDown));
		...
		case 5: {
			...
			leftScores = generateScores(Hand.LEFT, Arrays.asList(patternUp1, patternUp2, patternDown1, patternDown2), Arrays.asList(leftFingersUp1, leftFingersUp2, leftFingersDown1, leftFingersDown2), Arrays.asList(stepsUp1, stepsUp2, stepsDown1, stepsDown2));
			rightScores = generateScores(Hand.LEFT, Arrays.asList(patternUp1, patternUp2, patternDown1, patternDown2), Arrays.asList(rightFingersUp1, rightFingersUp2, rightFingersDown1, rightFingersDown2), Arrays.asList(stepsUp1, stepsUp2, stepsDown1, stepsDown2));
		...
		case 8: {
			...
			leftScores = generateScores(Hand.LEFT, Arrays.asList(patternUp, patternDown1, patternDown2), Arrays.asList(leftFingersUp, leftFingersDown1, leftFingersDown2), Arrays.asList(stepsUp, stepsDown1, stepsDown2));
			rightScores = generateScores(Hand.LEFT, Arrays.asList(patternUp, patternDown1, patternDown2), Arrays.asList(rightFingersUp, rightFingersDown1, rightFingersDown2), Arrays.asList(stepsUp, stepsDown1, stepsDown2));
			break;
		}
		...
		case 11: {
			...
			leftScores = generateScores(Hand.LEFT, Arrays.asList(patternUp1, patternUp2, patternUp3, patternDown1, patternDown2), Arrays.asList(leftFingersUp12, leftFingersUp12, leftFingersUp3, leftFingersDown12, leftFingersDown12), Arrays.asList(stepsUp1, stepsUp2, stepsUp3, stepsDown1, stepsDown2));
			rightScores = generateScores(Hand.RIGHT, Arrays.asList(patternUp1, patternUp2, patternUp3, patternDown1, patternDown2), Arrays.asList(rightFingersUp12, rightFingersUp12, rightFingersUp3, rightFingersDown12, rightFingersDown12), Arrays.asList(stepsUp1, stepsUp2, stepsUp3, stepsDown1, stepsDown2));
			break;
		}
		...
		case 19: {
			...
			leftScores = generateScores(Hand.LEFT, Arrays.asList(patternUp1, patternUp2, patternDown1, patternDown2), Arrays.asList(leftFingersUp12, leftFingersUp12, leftFingersDown1, leftFingersDown2), Arrays.asList(stepsUp1, stepsUp2, stepsDown1, stepsDown2));
			rightScores = generateScores(Hand.LEFT, Arrays.asList(patternUp1, patternUp2, patternDown1, patternDown2), Arrays.asList(rightFingersUp12, rightFingersUp12, rightFingersDown1, rightFingersDown2), Arrays.asList(stepsUp1, stepsUp2, stepsDown1, stepsDown2));
			break;
		}
		case 20: {
			name = "21";
		...
		case 24: {
			...
			leftScores = generateScores(Hand.LEFT, Arrays.asList(patternUp12, patternUp12, patternDown12, patternDown12), Arrays.asList(leftFingersUp1, leftFingersUp2, leftFingersDown1, leftFingersDown2), Arrays.asList(stepsUp1, stepsUp2, stepsDown1, stepsDown2));
			rightScores = generateScores(Hand.LEFT, Arrays.asList(patternUp12, patternUp12, patternDown12, patternDown12), Arrays.asList(rightFingersUp1, rightFingersUp2, rightFingersDown12, rightFingersDown12), Arrays.asList(stepsUp1, stepsUp2, stepsDown1, stepsDown2));
		...
		case 28: {
			...
			leftScores = generateScores(Hand.LEFT, Arrays.asList(patternUp12, patternUp12, patternDown1, patternDown2), Arrays.asList(leftFingersUp1, leftFingersUp2, leftFingersDown1, leftFingersDown2), Arrays.asList(stepsUp1, stepsUp2, stepsDown1, stepsDown2));
			rightScores = generateScores(Hand.LEFT, Arrays.asList(patternUp12, patternUp12, patternDown1, patternDown2), Arrays.asList(rightFingersUp1, rightFingersUp2, rightFingersDown1, rightFingersDown2), Arrays.asList(stepsUp1, stepsUp2, stepsDown1, stepsDown2));
		...
		case 30: {
			...
			leftScores = generateScores(Hand.LEFT, Arrays.asList(leftPatternUp, leftPatternDown), Arrays.asList(leftFingersUp, leftFingersDown), Arrays.asList(stepsUp, stepsDown));
			rightScores = generateScores(Hand.RIGHT, Arrays.asList(rightPatternUp, rightPatternDown), Arrays.asList(rightFingersUp, rightFingersDown), Arrays.asList(stepsUp, stepsDown));
		...
		case 32: {
			...
			leftScores = generateScores(Hand.LEFT, Arrays.asList(patternUp12, patternUp12, patternDown), Arrays.asList(leftFingersUp12, leftFingersUp12, leftFingersDown), Arrays.asList(stepsUp1, stepsUp2, stepsDown));
			rightScores = generateScores(Hand.LEFT, Arrays.asList(patternUp12, patternUp12, patternDown), Arrays.asList(rightFingersUp12, rightFingersUp12, rightFingersDown), Arrays.asList(stepsUp1, stepsUp2, stepsDown));
			break;
		}
